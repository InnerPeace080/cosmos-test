...
import (
	...
	cosmostestsimulation "github.com/InnerPeace080/cosmos-test/x/cosmostest/simulation"
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCreateGame,
		cosmostestsimulation.SimulateMsgCreateGame(am.accountKeeper, am.bankKeeper, am.keeper),
	))
